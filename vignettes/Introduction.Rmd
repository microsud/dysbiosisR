...
Here we use the test data from WirbelJ et al., (2018). The data consists of CRC and controls samples.  
...
```{r}
dysbiosis_1 |> 
  ggplot(aes(disease,score, color=disease)) +
  geom_boxplot(width = 0.3, show.legend = FALSE)+
  geom_jitter(width = 0.1, show.legend = FALSE) +
  theme_bw()+
  scale_color_manual(values = c(CRC="brown3", healthy ="steelblue")) +
...
```{r}
cloud.results |> 
  ggplot(aes(disease, log2Stats, color=disease)) +
  geom_boxplot(width = 0.3, show.legend = FALSE)+
  geom_jitter(width = 0.1, show.legend = FALSE) +
  theme_bw()+
  scale_color_manual(values = c(CRC="brown3", healthy ="steelblue")) +
...
```{r}
dysbiosis_2 |> 
  ggplot(aes(disease, CentroidDist_score, color=disease)) +
  geom_boxplot(width = 0.3, show.legend = FALSE)+
  geom_jitter(width = 0.1, show.legend = FALSE) +
  theme_bw()+
  scale_color_manual(values = c(CRC="brown3", healthy ="steelblue")) +
